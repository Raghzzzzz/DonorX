...
const runSimulation = async () => {
    try {
        ...
        const res = {
            status: (code) => ({ json: (data) => console.log(`Request Created: Status ${code}`, data._id) }),
            json: (data) => console.log('Request Response:', data)
        };

        // We have to mock creating request slightly differently because controller expects req/res
        // Ideally we'd call service, but for end-to-end of controller logic:
